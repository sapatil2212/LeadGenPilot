...
(function (global) {
  ...
  function renderShell() {
    ...
    app.innerHTML =
      ...
      `<button class="btn btn-sm btn-icon" data-theme title="Toggle theme">${icon("sun")}</button>` +
    ...
    qs("[data-logout]", app).addEventListener("click", logout);
    qs("[data-refresh]", app).addEventListener("click", refreshCurrent);
    qs("[data-theme]", app).addEventListener("click", toggleTheme);

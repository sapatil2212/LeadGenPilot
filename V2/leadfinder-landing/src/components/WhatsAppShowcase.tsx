        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 tracking-tight mb-3 leading-tight">
                Connect via the Channel Prospects Actually Answer
              </h2>
              <p className="text-sm text-slate-500 leading-relaxed font-normal max-w-xl">
                Skip crowded inboxes. Automated WhatsApp messages achieve <span className="font-semibold text-slate-700">90%+ open rates</span> with human-paced delivery and instant two-way CRM sync. Reach local businesses on the platform they check every few minutes — not the one buried under 200 unread emails.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-50/60 to-teal-50/40 border border-emerald-200/60 rounded-xl p-3.5">
              <p className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider mb-2.5">How It Works</p>
              <div className="flex items-start gap-3">
                <div className="flex flex-col items-center gap-0.5 flex-1">
                  <div className="w-7 h-7 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xs font-bold shadow-sm">1</div>
                  <p className="text-[11px] font-semibold text-slate-800 text-center mt-1">Scrape Leads</p>
                  <p className="text-[10px] text-slate-500 text-center leading-tight">Pull verified phone numbers from Google Maps</p>
                </div>
                <div className="flex items-center pt-3 text-emerald-400">
                  <ArrowRight className="w-3.5 h-3.5" />
                </div>
                <div className="flex flex-col items-center gap-0.5 flex-1">
                  <div className="w-7 h-7 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xs font-bold shadow-sm">2</div>
                  <p className="text-[11px] font-semibold text-slate-800 text-center mt-1">Auto-Personalize</p>
                  <p className="text-[10px] text-slate-500 text-center leading-tight">AI crafts custom messages using business data</p>
                </div>
                <div className="flex items-center pt-3 text-emerald-400">
                  <ArrowRight className="w-3.5 h-3.5" />
                </div>
                <div className="flex flex-col items-center gap-0.5 flex-1">
                  <div className="w-7 h-7 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xs font-bold shadow-sm">3</div>
                  <p className="text-[11px] font-semibold text-slate-800 text-center mt-1">Send & Track</p>
                  <p className="text-[10px] text-slate-500 text-center leading-tight">Deliver at human pace, sync replies to CRM</p>
                </div>
              </div>
            </div>

            {/* 3 Feature Pillars — Expanded */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-0.5">
              <div className="p-3.5 rounded-xl bg-slate-50/70 border border-slate-200/70">
                <div className="flex items-center gap-1.5 text-slate-900 font-semibold text-xs mb-1.5">
                  <Zap className="w-3.5 h-3.5 text-emerald-600 flex-shrink-0" />
                  <span>90%+ Open Rate</span>
                </div>
                <p className="text-[11px] text-slate-500 leading-snug">Messages land directly on their lock screen. Avg. seen within 3 minutes — 5× faster than email outreach.</p>
              </div>

              <div className="p-3.5 rounded-xl bg-slate-50/70 border border-slate-200/70">
                <div className="flex items-center gap-1.5 text-slate-900 font-semibold text-xs mb-1.5">
                  <Clock className="w-3.5 h-3.5 text-indigo-600 flex-shrink-0" />
                  <span>Human-Paced Sends</span>
                </div>
                <p className="text-[11px] text-slate-500 leading-snug">30–60s safety pauses between each message. Mimics natural typing so your number stays safe and unbanned.</p>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50/70 border border-slate-200/70">
                ...
                <p className="text-[11px] text-slate-500 leading-snug">Every reply auto-syncs to Google Sheets in real time. Track conversations, tag hot leads, and never miss a follow-up.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 sm:gap-6 pt-1 flex-wrap">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] text-slate-500 leading-tight">avg. reply<br/>rate</span>
              </div>
              <div className="w-px h-8 bg-slate-200" />
              <div className="flex items-center gap-1.5">
                <span className="text-lg font-bold text-indigo-600">3min</span>
                <span className="text-[11px] text-slate-500 leading-tight">avg. time<br/>to read</span>
              </div>
              <div className="w-px h-8 bg-slate-200" />
              <div className="flex items-center gap-1.5">
                <span className="text-lg font-bold text-violet-600">0%</span>
                <span className="text-[11px] text-slate-500 leading-tight">spam folder<br/>risk</span>
              </div>
            </div>

...
const faqs = [
  { q: "Does LeadGenPilot work for any business type or location?",
  ...
  { q: "Can I run LeadGenPilot on a server or cloud?",
    a: "Absolutely. LeadGenPilot ships with a Dockerfile and Render deployment config. It automatically falls back to High-Fidelity Simulation Mode in sandboxed environments." },
];
    ...
    <section id="faq" className="py-24 bg-slate-50">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider bg-slate-200/70 text-slate-600 border border-slate-200 mb-3">
            Frequently Asked Questions
          </span>
          <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 tracking-tight mb-3">
            Got <span className="gradient-text">Questions?</span>
          </h2>
          <p className="text-sm sm:text-base text-slate-500">Everything you need to know about LeadGenPilot and our scraping workflow.</p>
        </motion.div>

        ...
        <div className="sm:hidden bg-white border-t border-slate-200 px-5 py-3 space-y-1 shadow-xl">
          {navLinks.map((l) => (
            <Link
              ...
              className="block px-3 py-2 rounded-lg text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-950"
            >
              {l.label}
            </Link>
          ))}
          <div className="pt-2.5 mt-2 border-t border-slate-100 grid grid-cols-2 gap-2 pb-1">
            <a
              href="/app?mode=signin"
              className="h-8.5 rounded-lg text-xs font-medium border border-slate-200 text-slate-700 bg-white flex items-center justify-center gap-1.5 shadow-sm"
            >
              <LogIn className="w-3.5 h-3.5" /> Log In
            </a>
            <a
              href="/app?mode=signup"
              className="h-8.5 rounded-lg text-xs font-semibold text-white bg-slate-900 flex items-center justify-center gap-1.5 shadow-sm"
            >
              <span>Get Started</span>

      ...
      <main className="max-w-4xl mx-auto px-6 py-12 flex-1">
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/80 shadow-xs space-y-8 text-sm text-slate-700 leading-relaxed">
          ...
          <div>
            ...
            <p>
              You maintain full ownership of your data. You may request a complete export of your workspace leads or request complete account deletion at any time by contacting our privacy compliance team at <strong>leadgenpilot.in@gmail.com</strong>. Upon verified request, all personal data, API tokens, and associated records will be permanently purged within 30 days.
            </p>
          </div>

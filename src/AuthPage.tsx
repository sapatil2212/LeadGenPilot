...
function getInitialNotice(): string {
  if (typeof window === "undefined") return "";
  return new URLSearchParams(window.location.search).get("reason") === "inactive"
      ...
      if (mode === "signup") {
        ...
        if (!ok) {
          if (data.code === "email_not_registered") {
            setEmailError(data.error || "This email is not registered.");
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`${inputClass} ${emailError ? "border-rose-300 focus:border-rose-500 focus:ring-rose-500/15" : ""}`}
                      autoComplete="email"
                  ...
                  {emailError && (
                    <p id="login-email-error" className="mt-1 text-[11px] leading-relaxed text-rose-600" role="alert">
                      {emailError}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`${inputClass} pr-8 ${passwordError ? "border-rose-300 focus:border-rose-500 focus:ring-rose-500/15" : ""}`}
                  ...
                  {passwordError && (
                    <p id="login-password-error" className="mt-1 text-[11px] leading-relaxed text-rose-600" role="alert">
                      {passwordError}
                    </p>
                  )}
                ...
                {error && (
                  <div className="space-y-2">
                    ...
                    {error.toLowerCase().includes("suspended") && (
                      <a
                        href="mailto:leadgenpilot.in@gmail.com?subject=Suspended%20account%20support"
                        className="block w-full text-center text-xs font-semibold text-indigo-600 hover:text-indigo-700 transition-colors"
                      >
                        Email leadgenpilot.in@gmail.com
                      </a>
                    )}
                  </div>
                )}

    ...
    <section id="whatsapp-automation" className="py-16 sm:py-20 bg-white border-b border-slate-100 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* ──────────── RIGHT PART: COMPACT REAL SMARTPHONE MOCKUP ──────────── */}
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-[310px] sm:max-w-[325px]">
              
              {phoneStyle === "iphone" ? (
                /* ═══════════ COMPACT IPHONE 16 PRO MOCKUP ═══════════ */
                <div className="relative bg-[#2d3139] p-[8px] rounded-[44px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.35),0_0_0_1px_rgba(0,0,0,0.12)] border border-slate-700/60">
                  {/* Left Side Buttons */}
                  <div className="absolute -left-[11px] top-20 w-[3px] h-6 bg-slate-600 rounded-l-xs" />
                  <div className="absolute -left-[11px] top-30 w-[3px] h-10 bg-slate-600 rounded-l-xs" />
                  <div className="absolute -left-[11px] top-43 w-[3px] h-10 bg-slate-600 rounded-l-xs" />
                  
                  {/* Right Side Button */}
                  <div className="absolute -right-[11px] top-30 w-[3px] h-12 bg-slate-600 rounded-r-xs" />

                  {/* Inner Screen Bezel with Compact Height */}
                  <div className="relative bg-[#efeae2] rounded-[36px] overflow-hidden flex flex-col justify-between shadow-inner select-none h-[440px]">
                    
                    {/* Top Status Bar with Dynamic Island */}
                    <div className="bg-white/90 backdrop-blur-md pt-2 pb-1.5 px-5 flex items-center justify-between z-20 border-b border-black/[0.04]">
                      <span className="text-[11px] font-semibold text-black tracking-tight">12:25</span>
                      
                      {/* Dynamic Island Capsule */}
                      <div className="w-[82px] h-[20px] bg-black rounded-full flex items-center justify-between px-2 shadow-2xs">
                      ...
                      <div className="flex items-center gap-1 text-black">
                        <Wifi className="w-3 h-3 text-black stroke-[2.2]" />
                        <div className="w-4 h-2 border border-black rounded-xs p-0.5 flex items-center">
                          <div className="w-2.5 h-full bg-black rounded-2xs" />
                        </div>
                      </div>
                    </div>

                    {/* WhatsApp Top Navigation Bar */}
                    <div className="bg-white/95 backdrop-blur-md px-3 py-1.5 flex items-center justify-between border-b border-slate-200/80 z-20 shadow-2xs">
                      <div className="flex items-center gap-2">
                        <ChevronLeft className="w-4 h-4 text-[#007aff] -ml-1 cursor-pointer" />
                        <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center font-bold text-[10px] text-white shadow-2xs">
                          {scenario.avatar}
                        </div>
                        <div className="min-w-0">
                          <h4 className="text-[11px] font-semibold text-slate-900 truncate max-w-[125px] leading-tight">
                ...
                <div className="relative bg-[#1a1c1e] p-[7px] rounded-[40px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.35)] border border-slate-700">
                  {/* Right Side Buttons */}
                  <div className="absolute -right-[10px] top-24 w-[3px] h-8 bg-slate-600 rounded-r-xs" />
                  <div className="absolute -right-[10px] top-36 w-[3px] h-12 bg-slate-600 rounded-r-xs" />

                  <div className="relative bg-[#efeae2] rounded-[34px] overflow-hidden flex flex-col justify-between shadow-inner select-none h-[440px]">
                    {/* Android Status bar */}
                    <div className="bg-white/90 pt-1.5 pb-1 px-4 flex items-center justify-between text-[10px] text-slate-800 font-mono z-20">
                      <span>2:50</span>
                    ...
                    <div className="bg-white px-3 py-1.5 flex items-center justify-between border-b border-slate-200 z-20">
                      <div className="flex items-center gap-2">
                        <ChevronLeft className="w-4 h-4 text-slate-700 cursor-pointer" />
                        <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center font-bold text-[10px] text-white">
                          {scenario.avatar}
                        </div>
                        <div>
                          <h4 className="text-[11px] font-semibold text-slate-900 truncate max-w-[125px]">
                            {scenario.businessName}
                          </h4>
                          <p className="text-[9px] text-emerald-600 font-medium">online</p>
                        </div>
